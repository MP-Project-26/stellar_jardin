...
const BlogCard = ({blogs}) => {
    return (
        <div className="lg:px-40 lg:py-9 md:px-20 md:py-6 px-4 py-4 flex flex-wrap gap-4">
            <div
                className="w-full flex flex-col justify-center items-center mb-10 lg:mb-10 md:mb-10"
            ...
            <div className="flex w-full justify-center gap-4 flex-wrap md:h-auto">
                {blogs &&
                    blogs.map((item, index) => (
                        <div
                            key={index}
                            className="card lg:w-[30%] md:w-[30%] w-full shadow-xl rounded-none md:h-full"
                            data-aos="zoom-in-down
                    "
                        >
                            <figure>
