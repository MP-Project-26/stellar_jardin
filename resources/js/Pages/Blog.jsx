...
export default function Blog() {
    ...
    const getItemProps = (index) => ({
        className:
            active === index ? "bg-blue-gray-100 text-blue-gray-900" : "",
    ...
    return (
        <Layout title="Blog">
            <div className="w-full py-[12rem] px-0 md:px-[6rem] bg-white">
                <div className="flex flex-col items-center justify-center gap-8">
                    ...
                    <div className="flex flex-col md:flex-row   w-full items-center justify-between gap-[5rem] columns-2">
                        <div className="px-5 w-[65%] flex flex-col gap-[2rem]">
                            {data.map((item, index) => (
                        ...
                        {/* kanan */}
                        <div className="px-5   w-[35%] bg-red-100 sticky top-0">
